...
TASK = {'stage_id': 'save_predict', 'instruction': 'AUTO_AGENT_STAGE_ID: save_predict\nYou are the staged Auto AI agent. Run only this stage: Save and Predict.\nCurrent dataset version: v4; file sales_data_sample.csv; rows 2,823; columns 25; quality 100%.\nPrevious sandbox outputs and memory:\nauto_load_data_d1e0b9/task_8edc77e553; workflow=load_local_dataset->inspect_data->validate_outputs; files=cleaned.csv,cleaned.parquet,cleaning_manifest.json,data_profile_summary.json,execution_summary.json,features.csv,prepared_features.csv,validation_report.json; rows=2823\nauto_explore_data_813caf/task_ce94b232f2; workflow=load_local_dataset->explore_data->validate_outputs; files=cleaned.csv,cleaned.parquet,cleaning_manifest.json,data_profile_summary.json,execution_summary.json,features.csv,prepared_features.csv,validation_report.json; rows=2823\nauto_visualize_data_76b38c/task_bd3fa11506; workflow=load_local_dataset->visualize_data->validate_outputs; files=box_plot.png,cleaned.csv,cleaned.parquet,cleaning_manifest.json,correlation_heatmap.png,data_profile_summary.json,execution_summary.json,features.csv,histograms.png,missingness.png,pair_plot.png,pie_chart.png,prepared_features.csv,scatter_plot.png,validation_report.json; rows=2823\nauto_clean_data_76d719/task_a80bd6b502; workflow=load_local_dataset->clean_and_preprocess->validate_outputs; files=cleaned.csv,cleaned.parquet,cleaning_manifest.json,data_profile_summary.json,execution_summary.json,features.csv,prepared_features.csv,validation_report.json; rows=2823\nauto_feature_engineering_bfe819/task_699058ca88; workflow=load_local_dataset->feature_engineering->validate_outputs; files=cleaned.csv,cleaned.parquet,cleaning_manifest.json,data_profile_summary.json,execution_summary.json,features.csv,prepared_features.csv,validation_report.json; rows=2823\nauto_prepare_data_32eb54/task_163600ca55; workflow=load_local_dataset->feature_engineering->prepare_data->pca_variance->validate_outputs; files=cleaned.csv,cleaned.parquet,cleaning_manifest.json,data_profile_summary.json,execution_summary.json,features.csv,pca_features.csv,pca_variance.json,prepared_features.csv,validation_report.json; rows=2823; pca_variance=0.9546\nauto_split_data_657b1d/task_17af4d0d0b; workflow=load_local_dataset->feature_engineering->prepare_data->split_data->validate_outputs; files=cleaned.csv,cleaned.parquet,cleaning_manifest.json,data_profile_summary.json,execution_summary.json,features.csv,prepared_features.csv,split_summary.json,validation_report.json; rows=2823\nauto_train_model_728983/task_89578b47b3; workflow=load_local_dataset->feature_engineering->prepare_data->split_data->train_model->evaluate_model->validate_outputs; files=best_model.joblib,box_plot.png,cleaned.csv,cleaned.parquet,cleaning_manifest.json,correlation_heatmap.png,data_profile_summary.json,execution_summary.json,feature_importance.png,features.csv,histograms.png,missingness.png,model_accuracy_report.json,model_comparison.json,model_comparison.png,pair_plot.png,pca_features.csv,pca_variance.json,pca_variance.png,pie_chart.png,prediction_review.png,predictions.csv,prepared_features.csv,scatter_plot.png,split_summary.json,validation_report.json; rows=2823; model_metric=r2:0.9366; pca_variance=0.9546\nauto_tune_evaluate_06dd09/task_2006c3d8cd; workflow=load_local_dataset->feature_engineering->prepare_data->split_data->train_model->evaluate_model->validate_outputs; files=best_model.joblib,box_plot.png,cleaned.csv,cleaned.parquet,cleaning_manifest.json,correlation_heatmap.png,data_profile_summary.json,execution_summary.json,feature_importance.png,features.csv,histograms.png,missingness.png,model_accuracy_report.json,model_comparison.json,model_comparison.png,pair_plot.png,pca_features.csv,pca_variance.json,pca_variance.png,pie_chart.png,prediction_review.png,predictions.csv,prepared_features.csv,scatter_plot.png,split_summary.json,validation_report.json; rows=2823; model_metric=r2:0.9366; pca_variance=0.9546\nThink step by step inside the code. Write auditable outputs, validation_report.json, execution_summary.json, and any requested review artifacts.\nDo not skip validation. Train, review whether improvement is needed, loop through stronger engineered features when needed, choose the best model by test performance with an overfit penalty, and retrain/retest before finalizing.\nSave the best model artifact, create predictions.csv, model_accuracy_report.json, confusion matrix files when available, histograms, review plots, and final sandbox summary.', 'workflow': ['load_local_dataset', 'feature_engineering', 'prepare_data', 'split_data', 'train_model', 'evaluate_model', 'generate_predictions', 'validate_outputs'], 'target_hint': 'SALES', 'filter_hint': None, 'wants_model': True, 'wants_features': True, 'wants_pca': True, 'wants_plots': True, 'wants_auto_ml': True, 'wants_outliers': False, 'wants_inspection': True, 'wants_split': True, 'required_plot_files': []}
INPUT_PATH = Path("/home/user/numdux_projct/numdux/.numdux_data/runs/run_ffade11bb864/input/dataset.parquet")
OUTPUT_DIR = Path("/home/user/numdux_projct/numdux/.numdux_data/runs/run_ffade11bb864/output")
