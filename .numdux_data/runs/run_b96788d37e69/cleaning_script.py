...
TASK = {'stage_id': 'train_model', 'instruction': 'AUTO_AGENT_STAGE_ID: train_model\nYou are the staged Auto AI agent. Run only this stage: Feature Loop & Train.\nCurrent dataset version: v4; file Walmart_Sales.csv; rows 6,435; columns 8; quality 100%.\nPrevious sandbox outputs and memory:\nauto_load_data_c5c2cc/task_6052738948; workflow=load_local_dataset->inspect_data->validate_outputs; files=cleaned.csv,cleaned.parquet,cleaning_manifest.json,data_profile_summary.json,execution_summary.json,features.csv,prepared_features.csv,validation_report.json; rows=6435\nauto_explore_data_cece25/task_1e79852c3e; workflow=load_local_dataset->explore_data->validate_outputs; files=cleaned.csv,cleaned.parquet,cleaning_manifest.json,data_profile_summary.json,execution_summary.json,features.csv,prepared_features.csv,validation_report.json; rows=6435\nauto_visualize_data_e5e3b8/task_a34073d317; workflow=load_local_dataset->visualize_data->validate_outputs; files=box_plot.png,cleaned.csv,cleaned.parquet,cleaning_manifest.json,correlation_heatmap.png,data_profile_summary.json,execution_summary.json,features.csv,histograms.png,missingness.png,pair_plot.png,pie_chart.png,prepared_features.csv,scatter_plot.png,validation_report.json; rows=6435\nauto_clean_data_3f6a3f/task_a9366a8b8b; workflow=load_local_dataset->clean_and_preprocess->validate_outputs; files=cleaned.csv,cleaned.parquet,cleaning_manifest.json,data_profile_summary.json,execution_summary.json,features.csv,prepared_features.csv,validation_report.json; rows=6435\nauto_feature_engineering_2feccd/task_91d038e800; workflow=load_local_dataset->feature_engineering->validate_outputs; files=cleaned.csv,cleaned.parquet,cleaning_manifest.json,data_profile_summary.json,execution_summary.json,features.csv,prepared_features.csv,validation_report.json; rows=6435\nauto_prepare_data_1e0d41/task_4baef5f357; workflow=load_local_dataset->feature_engineering->prepare_data->pca_variance->validate_outputs; files=cleaned.csv,cleaned.parquet,cleaning_manifest.json,data_profile_summary.json,execution_summary.json,features.csv,pca_features.csv,pca_variance.json,prepared_features.csv,validation_report.json; rows=6435; pca_variance=0.9267\nauto_split_data_a0ffde/task_c1816ce2a2; workflow=load_local_dataset->feature_engineering->prepare_data->split_data->validate_outputs; files=cleaned.csv,cleaned.parquet,cleaning_manifest.json,data_profile_summary.json,execution_summary.json,features.csv,prepared_features.csv,split_summary.json,validation_report.json; rows=6435\nThink step by step inside the code. Write auditable outputs, validation_report.json, execution_summary.json, and any requested review artifacts.\nDo not skip validation. Train, review whether improvement is needed, loop through stronger engineered features when needed, choose the best model by test performance with an overfit penalty, and retrain/retest before finalizing.\nTrain multiple suitable models, then let the AI review performance. If score or overfit needs improvement, loop back through stronger feature engineering, retest feature sets, choose the best model again, and retrain.', 'workflow': ['load_local_dataset', 'feature_engineering', 'prepare_data', 'split_data', 'train_model', 'evaluate_model', 'validate_outputs'], 'target_hint': 'Date', 'filter_hint': None, 'wants_model': True, 'wants_features': True, 'wants_pca': True, 'wants_plots': True, 'wants_auto_ml': True, 'wants_outliers': False, 'wants_inspection': True, 'wants_split': True, 'required_plot_files': []}
INPUT_PATH = Path("/home/user/numdux_projct/numdux/.numdux_data/runs/run_b96788d37e69/input/dataset.parquet")
OUTPUT_DIR = Path("/home/user/numdux_projct/numdux/.numdux_data/runs/run_b96788d37e69/output")
