...
TASK = {'stage_id': 'load_data', 'instruction': 'AUTO_AGENT_STAGE_ID: load_data\nYou are the staged Auto AI agent. Run only this stage: Load Data.\nCurrent dataset version: v1; file sales_data_sample.csv; rows 2,823; columns 25; quality 96.7%.\nPrevious sandbox outputs and memory:\nNo prior sandbox output yet.\nThink step by step inside the code. Write auditable outputs, validation_report.json, execution_summary.json, and any requested review artifacts.\nDo not skip validation. Do not train a model in this stage.\nLoad the current dataset, verify schema, row count, columns, target candidates, missing values, duplicate rows, and write data_profile_summary.json.', 'workflow': ['load_local_dataset', 'inspect_data', 'validate_outputs'], 'target_hint': 'SALES', 'filter_hint': None, 'wants_model': False, 'wants_features': False, 'wants_pca': False, 'wants_plots': False, 'wants_auto_ml': False, 'wants_outliers': False, 'wants_inspection': True, 'wants_split': False, 'required_plot_files': []}
INPUT_PATH = Path("/home/user/numdux_projct/numdux/.numdux_data/runs/run_923008764ec3/input/dataset.csv")
OUTPUT_DIR = Path("/home/user/numdux_projct/numdux/.numdux_data/runs/run_923008764ec3/output")
