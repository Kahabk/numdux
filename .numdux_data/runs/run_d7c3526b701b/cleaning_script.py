...
TASK = {'stage_id': 'explore_data', 'instruction': 'AUTO_AGENT_STAGE_ID: explore_data\nYou are the staged Auto AI agent. Run only this stage: Explore Data.\nCurrent dataset version: v1; file Walmart_Sales.csv; rows 6,435; columns 8; quality 100%.\nPrevious sandbox outputs and memory:\nauto_load_data_c5c2cc/task_6052738948; workflow=load_local_dataset->inspect_data->validate_outputs; files=cleaned.csv,cleaned.parquet,cleaning_manifest.json,data_profile_summary.json,execution_summary.json,features.csv,prepared_features.csv,validation_report.json; rows=6435\nThink step by step inside the code. Write auditable outputs, validation_report.json, execution_summary.json, and any requested review artifacts.\nDo not skip validation. Do not train a model in this stage.\nExplore the current dataset. Summarize numeric and categorical columns, target candidates, missingness, duplicates, outliers, and data risks. Save inspection outputs.', 'workflow': ['load_local_dataset', 'explore_data', 'validate_outputs'], 'target_hint': 'Date', 'filter_hint': None, 'wants_model': False, 'wants_features': False, 'wants_pca': False, 'wants_plots': False, 'wants_auto_ml': False, 'wants_outliers': False, 'wants_inspection': True, 'wants_split': False, 'required_plot_files': []}
INPUT_PATH = Path("/home/user/numdux_projct/numdux/.numdux_data/runs/run_d7c3526b701b/input/dataset.csv")
OUTPUT_DIR = Path("/home/user/numdux_projct/numdux/.numdux_data/runs/run_d7c3526b701b/output")
